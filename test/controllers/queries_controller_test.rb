...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { body: @query.body, email: @query.email, name: @query.name, subject: @query.subject }
    end
  ...
  test "should update query" do
    patch :update, id: @query, query: { body: @query.body, email: @query.email, name: @query.name, subject: @query.subject }
    assert_redirected_to query_path(assigns(:query))
  end
